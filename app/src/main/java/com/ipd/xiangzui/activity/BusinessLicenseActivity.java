...
public class BusinessLicenseActivity extends BaseActivity {
    ...
    public void init() {
        ...
        //防止状态栏和标题重叠
        ImmersionBar.setTitleBar(this, tvBusinessLicense);
    }
                    ...
                    Glide.with(this)
                            ...
                            .into(new SimpleTarget<Drawable>() {
                                ...
                                public void onResourceReady(Drawable resource, Transition<? super Drawable> transition) {
                                    rivBusinessLicense.setImageDrawable(resource);
                                }
                            });
                    break;
            }
    ...
    @OnClick({R.id.riv_business_license, R.id.sb_confirm})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.riv_business_license:
            ...
            case R.id.sb_confirm:
                setResult(RESULT_OK, new Intent().putExtra("business_license", 1));
                finish();
                break;
        }
    }
